...
// This test checks the dynamic compatibility test for the sonarqube standard chart
...
func TestDeploymentWithDefaultValues(t *testing.T) {
	t.Parallel()
	t.Run("Standard chart with Default values as Deployment", func(t *testing.T) {
		// ******* GIVEN *********
