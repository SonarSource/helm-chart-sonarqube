...
{{- if or (.Values.httpProxy) (.Values.httpsProxy) (.Values.noProxy) (.Values.ApplicationNodes.prometheusExporter.httpProxy) (.Values.ApplicationNodes.prometheusExporter.httpsProxy) (.Values.ApplicationNodes.prometheusExporter.noProxy) }}true{{- end -}}
{{- end -}}
...
{{- if or (.Values.httpProxy) (.Values.httpsProxy) (.Values.noProxy) (.Values.ApplicationNodes.plugins.httpProxy) (.Values.ApplicationNodes.plugins.httpsProxy) (.Values.ApplicationNodes.plugins.noProxy) }}true{{- end -}}
{{- end -}}
...
{{- $httpProxy := default .Values.httpProxy .Values.ApplicationNodes.prometheusExporter.httpProxy -}}
{{- $httpsProxy := default .Values.httpsProxy .Values.ApplicationNodes.prometheusExporter.httpsProxy -}}
{{- $noProxy := default .Values.noProxy .Values.ApplicationNodes.prometheusExporter.noProxy -}}
{{- if $httpProxy }}
- name: http_proxy
  valueFrom:
    secretKeyRef:
...
{{- $httpProxy := default .Values.httpProxy .Values.ApplicationNodes.plugins.httpProxy -}}
{{- $httpsProxy := default .Values.httpsProxy .Values.ApplicationNodes.plugins.httpsProxy -}}
{{- $noProxy := default .Values.noProxy .Values.ApplicationNodes.plugins.noProxy -}}
{{- if $httpProxy }}
- name: http_proxy
  valueFrom:
    secretKeyRef:
