...
## [2026.1.6]
* Upgrade Chart's version to 2026.1.6
* Upgrade SonarQube Server to 2026.1.6
...
* Fix http-route rendering when using multiple hostnames
...
* Update ingress-nginx subchart to v4.14.3
