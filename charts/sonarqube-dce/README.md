...
| `searchNodes.nodeSelector`                                | Node labels for search nodes' pods assignment, global nodeSelector takes precedance                                                                                                                                          | `{}` |
| `searchNodes.affinity`                                    | Node / Pod affinities for searchNodes, global affinity takes precedance                                                                                                                                          | `{}` |
| `searchNodes.tolerations`                                 | List of node taints to tolerate for searchNodes, global tolerations takes precedance                                                                                                                                          | `[]` |
...
| `ApplicationNodes.nodeSelector`                                | Node labels for application nodes' pods assignment, global nodeSelector takes precedance                                                                                                                                          | `{}` |
| `ApplicationNodes.affinity`                                    | Node / Pod affinities for ApplicationNodes, global affinity takes precedance                                                                                                                                          | `{}` |
| `ApplicationNodes.tolerations`                                 | List of node taints to tolerate for ApplicationNodes, global tolerations takes precedance                                                                                                                                          | `[]` |
