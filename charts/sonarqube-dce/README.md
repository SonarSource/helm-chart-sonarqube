...
| `vortexAnalysis.image.tag`                      | Vortex analysis image tag                                                                                        | `""`                                                                   |
| `vortexAnalysis.image.pullPolicy`               | Vortex analysis image pull policy                                                                                | `IfNotPresent`                                                         |
| `vortexAnalysis.image.pullSecrets`              | imagePullSecrets for the Vortex analysis image (merged with the application nodes')                              | `nil`                                                                  |
...
| `vortexAnalysis.sonarqubeToken.token`           | Inline SonarQube token for the callback (`VORTEX_ANALYSIS_SONARQUBE_TOKEN`)                                       | `""`                                                                   |
| `vortexAnalysis.sonarqubeToken.existingSecret`  | Existing secret providing the callback token                                                                     | `""`                                                                   |
...
| `vortexAnalysis.networkPolicy.egressAllow`      | Extra egress peers — each `{cidr}` or `{podSelector[,namespaceSelector]}`, with optional `ports`                 | `[]`                                                                   |
