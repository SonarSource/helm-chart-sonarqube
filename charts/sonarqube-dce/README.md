...
| `agenticHarness.agenticAnalysis.url`                             | Base URL of the (independently-deployed) Agentic Analysis service; sets `SONAR_AGENTICANALYSIS_URL` so SonarQube polls `<url>/health`, same as MCP health. Blank disables health polling | `""`                                                                           |
