...
If you are using the Prometheus Operator, you can enable PodMonitor with `prometheusExporter.podMonitor.enabled` 
...
| `ApplicationNodes.prometheusExporter.podMonitor.enabled` | Enable Prometheus PodMonitor | `false` |
| `ApplicationNodes.prometheusExporter.podMonitor.namespace` | Specify a custom namespace where the PodMonitor will be created | `""` |
| `ApplicationNodes.prometheusExporter.podMonitor.interval` | Specify the interval how often metrics should be scraped | `30s` |
| `ApplicationNodes.prometheusExporter.podMonitor.scrapeTimeout` | Specify the timeout after a scrape is ended | `""` |
| `ApplicationNodes.prometheusExporter.podMonitor.jobLabel` |  Name of the label on target services that prometheus uses as job name | `""` |
