...
| `agentOrchestrator.terminationGracePeriodSeconds`                     | Orchestrator pod grace period; ships unconditionally. Must comfortably exceed the orchestrator image's `spring.lifecycle.timeout-per-shutdown-phase` (`1260`s)                          | `1320`                                                                         |
