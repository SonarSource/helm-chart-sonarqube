...
| `vortex.autoscaling.minReplicas`         | Minimum replicas; validated `>= 2` (`>= 1` when `aggregateAcrossReplicas` is `false` - no scale-to-zero for this fleet) | `3`                                                     |
