...
| `vortex.autoscaling.minReplicas`         | Minimum replicas; validated `>= 2` (no scale-to-zero for this fleet)                                     | `2`                                                                    |
| `vortex.autoscaling.maxReplicas`         | Maximum replicas                                                                                          | `10`                                                                   |
