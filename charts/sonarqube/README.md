...
SonarQube Community Build: `26.9.0.129388`. If you want the use a more recent SonarQube Community Build, please set the `community.buildNumber` with the desired version.
...
helm upgrade sonarqube sonarqube/sonarqube --version 2026.4.0 -f gateway-api-migration-sonarqube/values-coexist-sonarqube.yaml -n sonarqube
...
| `mcp.image.tag`                        | MCP container image tag                                                                                  | `"1.27.0.4335"`                                                        |
