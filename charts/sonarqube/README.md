...
| `vortex.storage.type`                   | Object storage backend for Vortex analysis context restoration (`SONAR_AGENTIC_STORAGE_TYPE`); required          | `S3`                                                                   |
| `vortex.storage.bucket`                 | Bucket holding Vortex analysis context items (`SONAR_AGENTIC_STORAGE_BUCKET`); required                          | `""`                                                                   |
| `vortex.storage.region`                 | AWS region of the bucket (`SONAR_AGENTIC_STORAGE_REGION`); required                                               | `""`                                                                   |
...
| `agentOrchestrator.storage.bucket`                                    | Object-storage bucket for the shared job artifacts (required when enabled)                                                               | `agent-jobs`                                                                 |
