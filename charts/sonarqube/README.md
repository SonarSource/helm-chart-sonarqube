...
SonarQube Community Build: `26.5.0.122824`. If you want the use a more recent SonarQube Community Build, please set the `community.buildNumber` with the desired version.
...
| `community.buildNumber` | The SonarQube Community Build number to install                                                                       | `26.5.0.122824`    |
