...
mpdev install \
  ...
  --parameters='{"name": "sonarqube-dce-gcapp-test", "namespace": "test-ns","ApplicationNodes.jwtSecret": "dZ0EB0KxnF++nr5+4vfTCaun/eWbv6gOoXodiAMqcFo=", "jdbcOverwrite.jdbcUrl": "jdbc:postgresql://myPostgres/myDatabase", "jdbcOverwrite.jdbcUsername": "username", "jdbcOverwrite.jdbcPassword": "password" }'
```
